export default function BlackBox({ level, terminalPair }) {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-6">
      ...
      <svg viewBox="0 0 400 180" className="w-full max-w-md mx-auto">
        ...
        <text x="200" y="95" textAnchor="middle" fill="#6b7280" fontSize="13" fontFamily="monospace" fontWeight="500">
          SEALED
        </text>
        ...
        {isLevel3 ? (
          <>
            ...
            <line x1="100" y1="100" x2="100" y2="165" stroke="#dc2626" strokeWidth="2.5" />
            <circle cx="100" cy="168" r="4" fill="#dc2626" />
            ...
            <line x1="300" y1="100" x2="300" y2="165" stroke="#2563eb" strokeWidth="2.5" />
            <circle cx="300" cy="168" r="4" fill="#2563eb" />
            ...
            {[
              ...
              return (
                <g key={t.label}>
                  ...
                  <line x1={t.x} y1="100" x2={t.x} y2="165" stroke={active ? t.color : '#6b7280'} strokeWidth="2.5" />
                  <circle cx={t.x} cy="168" r="4" fill={active ? t.color : '#6b7280'} />
